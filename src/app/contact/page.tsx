    ...
    <main className="flex flex-1 flex-col">
      <section className="bg-cream">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center sm:px-6 sm:py-28">
          <span className="text-xs font-semibold uppercase tracking-[0.3em] text-brand/50">
            On est là
          </span>
          <h1 className="mt-4 font-serif text-4xl font-semibold tracking-tight text-brand sm:text-5xl">
            Contact
          </h1>
          <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-brand/60">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="flex items-center gap-2 rounded-full bg-brand px-8 py-3 text-sm font-semibold uppercase tracking-[0.1em] text-white shadow-lg transition-colors hover:bg-brand-soft"
            >
            ...
            <a
              ...
              className="rounded-full border border-brand/20 px-8 py-3 text-sm font-semibold uppercase tracking-[0.1em] text-brand transition-colors hover:border-brand/40"
            >
              {SERVICE_PHONE_DISPLAY}
            </a>
          </div>
      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-px overflow-hidden rounded-2xl border border-brand/10 bg-brand/10 sm:grid-cols-3">
          {HORAIRES.map((item) => (
            <div key={item.label} className="bg-white px-6 py-8">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-brand/40">
                {item.label}
              </p>
              <p className="mt-2 font-serif text-lg font-semibold text-brand">
                {item.value}
              </p>
            </div>
          ))}
        ...
        <div className="mx-auto mt-20 max-w-5xl px-6 pb-20 sm:px-6">
          ...
          <h2 className="mt-3 font-serif text-3xl font-semibold tracking-tight text-brand">
            Nos secteurs
          </h2>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-3xl px-6 py-20 sm:px-6">
          ...
          <div className="mt-10 divide-y divide-brand/10 border-t border-brand/10">
            {FAQ.map((item) => (
      ...
      <section className="bg-white">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 px-6 py-20 text-center sm:px-6">
          <h2 className="font-serif text-3xl font-semibold tracking-tight text-brand">
            Prêt à commander ?
          </h2>
          <p className="max-w-lg text-sm leading-relaxed text-brand/60">
            Composez votre chicha, on vous l&apos;apporte en personne où que
            vous soyez en Île-de-France.
          </p>
          <Link
            href="/commande"
            className="rounded-full bg-brand px-8 py-3 text-sm font-semibold uppercase tracking-[0.1em] text-white shadow-lg transition-colors hover:bg-brand-soft"
          >
