        ...
        <div className="mx-auto max-w-4xl px-6 py-20 text-center sm:px-6 sm:py-28">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="flex items-center gap-2 rounded-full bg-signal px-8 py-3 text-sm font-semibold uppercase tracking-[0.1em] text-white shadow-lg transition-colors hover:bg-signal-hover"
            >
            ...
            <a
              ...
              className="rounded-full border border-border px-8 py-3 text-sm font-semibold uppercase tracking-[0.1em] text-ink transition-colors hover:border-ink/30"
            >
              {SERVICE_PHONE_DISPLAY}
            </a>
          </div>
